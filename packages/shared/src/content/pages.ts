  ...
  openRoles: [
    {
      ...
      seoDescription:
        `Cleaning Supervisor at Atlas South, London. Lead on-site cleaning teams across corporate and commercial client sites. Full-time, permanent.${SEO_PHONE_CTA}`,
      roleOverview:
    ...
    },
    {
      ...
      seoDescription:
        `Junior Sales Executive at Atlas South, London. Build a pipeline and support new corporate facilities contracts. Full-time, hybrid.${SEO_PHONE_CTA}`,
      roleOverview:
    ...
    },
    {
      ...
      seoDescription:
        `Senior Sales Manager at Atlas South, London. Lead new business development across our corporate client base. Full-time, permanent, hybrid.${SEO_PHONE_CTA}`,
      roleOverview:
