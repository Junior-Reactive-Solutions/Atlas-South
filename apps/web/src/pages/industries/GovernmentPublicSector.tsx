...
export function GovernmentPublicSector() {
  const { data, isLoading, error } = useContentPage<IndustryContent>('government-public-sector');
  ...
  return <IndustryDetailPage id="government-public-sector" path="/industries/government-public-sector" {...data} />;
}
